...
The package offers two functions for the purpose of portfolio estimation and evaluation: `expanding_tvmvp` which implements an expanding window in order to evaluate the performance of a minimum variance portfolio implemented using the time-varying covariance matrix, and `predict_portfolio` which implements an out of sample prediction of the portfolio.
